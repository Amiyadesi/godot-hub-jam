...
func _test_start_scene_camera_layout() -> void:
	var scene := load("res://Scenes/DelayTrace/delay_trace_start.tscn") as PackedScene
...
func _test_present_departure_vfx_finishes_cleanly() -> void:
	var vfx_scene := load("res://Scenes/DelayTrace/Prefabs/temporal_departure_vfx.tscn") as PackedScene
...
func _test_dash_afterimages_restart_cleanly() -> void:
	var vfx_scene := load("res://Scenes/DelayTrace/Prefabs/echo_dash_vfx.tscn") as PackedScene
