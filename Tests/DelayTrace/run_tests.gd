...
const TEMPORAL_FRAME_SCRIPT := preload("res://Scripts/DelayTrace/temporal_frame.gd")
const TEMPORAL_TRACK_SCRIPT := preload("res://Scripts/DelayTrace/temporal_track.gd")
const PLAYER_SCENE := preload("res://Scenes/DelayTrace/Prefabs/echo_player.tscn")
const PRESSURE_PLATE_SCENE := preload("res://Scenes/DelayTrace/Prefabs/temporal_pressure_plate.tscn")
const TEMPORAL_DOOR_SCENE := preload("res://Scenes/DelayTrace/Prefabs/temporal_door.tscn")
const FUTURE_ECHO_SCENE := preload("res://Scenes/DelayTrace/Prefabs/future_echo.tscn")
...
func _test_temporal_door_latched_state_round_trip() -> void:
	...
	_expect(module.is_latched_door_open("latched_round_trip"), "identified Latched door opens in runtime memory")
	...
	_expect(not restored.is_latched_door_open("latched_round_trip"), "uncommitted Latched door is excluded from data round-trip")
	module.commit_latched_doors()
	restored.apply_data(module.collect_data())
	_expect(restored.is_latched_door_open("latched_round_trip"), "checkpoint-committed Latched door survives data round-trip")
