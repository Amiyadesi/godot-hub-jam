...
const SCENE1_PATH := "res://Dialogue/Examples/demo/scene1_tutorial.dialogue"
const SCENE2_PATH := "res://Dialogue/Examples/demo/scene2_characters.dialogue"
const SCENE3_PATH := "res://Dialogue/Examples/demo/scene3_branch.dialogue"
